...
from ..forms import SexualHistoryAndBehaviourForm
from ..models import SexualHistoryAndBehaviour


@admin.register(SexualHistoryAndBehaviour)
class SexualHistoryAndBehaviourAdmin(admin.ModelAdmin):

    form = SexualHistoryAndBehaviourForm
