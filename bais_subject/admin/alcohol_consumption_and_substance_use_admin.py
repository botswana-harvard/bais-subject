...
from ..forms import AlcoholConsumptionAndSubstanceUseForm
from ..models import AlcoholConsumptionAndSubstanceUse


@admin.register(AlcoholConsumptionAndSubstanceUse)
class AlcoholConsumptionAndSubstanceUseAdmin(admin.ModelAdmin):

    form = AlcoholConsumptionAndSubstanceUseForm
