...
class HouseholdQuestionnaireAdmin(admin.ModelAdmin):
    ...
    radio_fields = {
        ...
        'person_biological_mother_household': admin.VERTICAL,
        'person_biological_father_alive': admin.VERTICAL,
        'person_biological_father_household': admin.VERTICAL,
    ...
    fieldsets = (
        ('Household Questionnaire', {
            'fields': (
                ...
                'person_biological_mother_household',
                'person_biological_father_alive',
                'person_biological_father_household',
