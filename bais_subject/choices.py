...
BABY_FEEDING = (
    ...
    ('FORMULA_BREAST_MILK_AND_SOLID_FOOD', 'FORMULA, BREAST MILK AND SOLID FOOD')
)
...
TRANSMISSION_PREVENTION = (
    ('ANTIRETROVIRAL_THERAPY', 'ANTIRETROVIRAL THERAPY (AZT, DRUGS BEFORE BIRTH)'),
...
TB_INFECTION = (
    ...
    ('ONLY_PEOPLE_WHO_HAVE_BEEN_IN_PRISON', 'ONLY PEOPLE WHO HAVE BEEN IN PRISON'),
    (DONT_KNOW, 'Don\'t Know')
)
...
TB_SPREAD = (
    ...
    ('SEX_WITH_A_WOMAN_WHO_MISCARRIED', 'SEX WITH A WOMAN WHO MISCARRIED'),
    ('SEX_WITH_A_WIDOWER', 'SEX WITH A WIDOWER'),
    ('BORN_IN_A_FAMILY_WITH_HIV', 'BORN IN A FAMILY WITH HIV'),
    ('HANDSHAKE', 'HANDSHAKE'),
    ('TOUCHING_ITEMS_IN_PUBLIC_PLACES ', 'TOUCHING ITEMS IN PUBLIC PLACES'
     '(Door knobs, etc.)'),
    (DONT_KNOW, 'Don\'t Know'),
    (OTHER, 'OTHER, SPECIFY')
)
...
REASONS_NOT_TESTED = (
    ...
    ('FEAR_MY_PARTNERS_POSSIBLE_REACTION', 'FEAR MY PARTNER’S POSSIBLE REACTION'),
    ('MY_PARTNER_RECENTLY_TESTED_NEGATIVE', 'MY PARTNER RECENTLY TESTED NEGATIVE'),
